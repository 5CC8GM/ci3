			...
			<li class="nav-item dropdown dropdown-user">
				<a href="#"
				   ...
				   data-toggle="dropdown">
					<img src="<?= base_url() ?>components/global_assets/images/image.png"
						 class="rounded-circle mr-2"
						 height="34"
						 alt="">
					<span><?= $this->session->userdata('nombre') . ' ' . $this->session->userdata('apellido')
						?></span>
				</a>
				
				<div class="dropdown-menu dropdown-menu-right">
					<a href="<?= base_url() ?>autenticacion/cerrarSesion"
					   class="dropdown-item"><i class="icon-switch2 text-danger-800"></i> Cerrar Sesión</a>
				</div>
			</li>
		</ul>
	</div>
