...
<html lang="en">
	<head>
		...
		<!-- Theme JS files -->
		<script src="<?= base_url() ?>components/global_assets/js/plugins/forms/styling/uniform.min.js"></script>
	...
	<body>
			...
			<div class="content-wrapper">
				...
				<div class="content d-flex justify-content-center align-items-center pt-0">
					...
					<form class="login-form"
						  action="<?= base_url() ?>autenticacion/login"
						  method="post"
						  id="formularioLogin">
						<div class="card mb-0">
							<div class="card-body">
								<div class="text-center mb-3">
									...
									<span class="d-block text-muted">Credenciales de Acceso</span>
								</div>
								<?php if ($this->session->flashdata('error')) : ?>
									
									<div class="alert alert-danger">
										<span class="font-weight-semibold"><?= $this->session->flashdata('error') ?></span>
									</div>
								...
								<div class="form-group">
									<button type="submit"
											class="btn bg-primary-800 btn-block">Iniciar Sesión
		...
		<script src="<?= base_url() ?>components/scripts/login.js"></script>
	</body>
</html>
