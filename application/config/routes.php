<?php
	...
	*/
	...
	$route['getDataPloteo'] = 'dashboard/getDataPloteo';
	...
	$route['reportes/mostrarServicioTecnico'] = 'ordenes_trabajo/reportes/mostrarServicioTecnico';
	$route['reportes/mostrarPloteo'] = 'ordenes_trabajo/reportes/mostrarPloteo';
