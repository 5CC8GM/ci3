	...
	class Servicio_tecnico extends CI_Controller {
		...
		public function crear() {
			...
			if ($this->input->is_ajax_request()) {
				...
				$this->form_validation->set_rules('Precio_OTServicio_Tecnico', 'Precio', 'required|numeric|trim', array('required' => '<br>' . 'El precio es obligatorio', 'numeric' => '<br>' . 'El precio debe tener solo números'));
