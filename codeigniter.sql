...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-08-2020 a las 22:27:15
...
(68, 3, 2, 22.50, 2.70, 25.20, '000142', '001', '2020-08-20 22:45:50'),
(69, 4, 1, 11.25, 0.00, 11.25, '000029', '001', '2020-08-22 23:02:33');
...
(188, 3, 2, 'Asus', 'Strix 3080ti', 'Instalacion Tarjeta de Video', 30.00, 3.60, 33.60, '000103', '001', '2020-08-18 20:34:25');
...
--
ALTER TABLE `detalle_otploteo`
  MODIFY `ID_DetalleOTPloteo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT de la tabla `detalle_otservicio_tecnico`
--
ALTER TABLE `detalle_otservicio_tecnico`
  MODIFY `ID_DetalleOTServicioTecnico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;

--
-- AUTO_INCREMENT de la tabla `ot_ploteo`
--
ALTER TABLE `ot_ploteo`
  MODIFY `ID_OTPloteo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;

--
-- AUTO_INCREMENT de la tabla `ot_servicio_tecnico`
--
ALTER TABLE `ot_servicio_tecnico`
  MODIFY `ID_OTServicioTecnico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=197;
